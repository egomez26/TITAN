 ...
 *******************************************************************************/
package org.pnpl.export.greatspn.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/pnpl/export/greatspn/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
         ...
         */
        if(!isInWorkspace(PetriNetsPackage.class)){
        	resourceSet.getPackageRegistry().put(PetriNetsPackage.eINSTANCE.getNsURI(), PetriNetsPackage.eINSTANCE);
        }
    }
