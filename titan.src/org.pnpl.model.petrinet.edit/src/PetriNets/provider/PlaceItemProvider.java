...
/**
 * This is the item provider adapter for a {@link PetriNets.Place} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlaceItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMarkingPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetriNetsPackage.Literals.PLACE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Marking feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMarkingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_marking_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_marking_feature", "_UI_Place_type"),
				 PetriNetsPackage.Literals.PLACE__MARKING,
				 true,
				 false,
				 false,
	...
	protected void addOutputsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_outputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_outputs_feature", "_UI_Place_type"),
				 PetriNetsPackage.Literals.PLACE__OUTPUTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addInputsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_inputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_inputs_feature", "_UI_Place_type"),
				 PetriNetsPackage.Literals.PLACE__INPUTS,
				 true,
				 false,
				 true,
				 null,
