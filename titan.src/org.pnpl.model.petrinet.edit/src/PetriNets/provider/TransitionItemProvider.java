...
/**
 * This is the item provider adapter for a {@link PetriNets.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetriNetsPackage.Literals.TRANSITION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetriNetsPackage.Literals.TRANSITION__INPUTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutputsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_outputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_outputs_feature", "_UI_Transition_type"),
				 PetriNetsPackage.Literals.TRANSITION__OUTPUTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDelayPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_delay_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_delay_feature", "_UI_Transition_type"),
				 PetriNetsPackage.Literals.TRANSITION__DELAY,
				 true,
				 false,
				 false,
